...
# Import the controller implementation
...
def get_controller() -> UsersControllerProtocol:
    """Dependency to get the controller implementation."""
...
async def create_user(
    ...
    controller: Annotated[UsersControllerProtocol, Depends(get_controller)],
