...
- [ ] Unit тесты: Protocol включает все типы операций
- [ ] Unit тесты: Сигнатуры методов корректны для каждого типа

**Проверка**: `make test-unit` проходит, protocol содержит все операции.
